...
const Slider = React.forwardRef((_a, ref) => {
    var {className, defaultValue, value, min = 0, max = 100} = _a,
    ...
    return (_jsxs(SliderPrimitive.Root, Object.assign({
        ...
        children: [_jsx(SliderPrimitive.Track, {
            ...
            children: _jsx(SliderPrimitive.Range, {className: "absolute h-full bg-gradient-to-r from-neumorphic-primary to-neumorphic-primary-light shadow-neumorphic-flat"})
        }), Array.from({length: _values.length}, (_, index) => (_jsx(SliderPrimitive.Thumb, {
