...
function Card(_a) {
    ...
    return (_jsx("div", Object.assign({ "data-slot": "card", className: cn("bg-neumorphic-bg border border-neumorphic-border shadow-neumorphic-raised rounded-2xl text-neumorphic-text flex flex-col gap-6 py-6", className) }, props)));
}
...
function CardTitle(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx("div", Object.assign({ "data-slot": "card-title", className: cn("leading-none font-semibold text-neumorphic-text", className) }, props)));
}
function CardDescription(_a) {
    var { className } = _a, props = __rest(_a, ["className"]);
    return _jsx("div", Object.assign({ "data-slot": "card-description", className: cn("text-neumorphic-text-muted text-sm", className) }, props));
}
