...
function ResizablePanelGroup(_a) {
    ...
    return (_jsx(ResizablePrimitive.PanelGroup, Object.assign({ "data-slot": "resizable-panel-group", className: cn("flex h-full w-full data-[panel-group-direction=vertical]:flex-col", className) }, props)));
}
