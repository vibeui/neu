...
function BreadcrumbSeparator(_a) {
    ...
    }, props, {children: children !== null && children !== void 0 ? children : _jsx(ChevronRight, {})})));
}
...
function BreadcrumbEllipsis(_a) {
    ...
    return (_jsxs("span", Object.assign({
        ...
        children: [_jsx(MoreHorizontal, {className: "size-4"}), _jsx("span", {
            className: "sr-only",
            children: "More"
        })]
    })));
