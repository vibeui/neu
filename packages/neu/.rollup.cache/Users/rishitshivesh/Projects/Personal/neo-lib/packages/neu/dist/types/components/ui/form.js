...
const FormField = (_a) => {
    ...
    return (_jsx(FormFieldContext.Provider, {
        ...
        children: _jsx(Controller, Object.assign({}, props))
    }));
};
const useFormField = () => {
...
function FormItem(_a) {
    ...
    return (_jsx(FormItemContext.Provider, {
        value: {id},
        children: _jsx("div", Object.assign({"data-slot": "form-item", className: cn("grid gap-2", className)}, props))
    }));
}
...
function FormLabel(_a) {
    ...
    return (_jsx(Label, Object.assign({
...
function FormControl(_a) {
    ...
    return (_jsx(Slot, Object.assign({
        "data-slot": "form-control", id: formItemId, "aria-describedby": !error
            ? `${formDescriptionId}`
