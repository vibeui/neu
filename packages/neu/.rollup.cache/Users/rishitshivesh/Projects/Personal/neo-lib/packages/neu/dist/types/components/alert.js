...
const Alert = React.forwardRef((_a, ref) => {
    ...
    return (_jsx("div", Object.assign({ ref: ref, role: "alert", className: cn("bg-neumorphic-bg border border-neumorphic-border shadow-neumorphic-raised text-neumorphic-text", "relative w-full rounded-xl p-4 transition-all duration-200", alertVariants({ variant }), className) }, props)));
});
