...
function DropdownMenuContent(_a) {
    ...
    return (_jsx(DropdownMenuPrimitive.Portal, {
        children: _jsx(DropdownMenuPrimitive.Content, Object.assign({
...
function DropdownMenuItem(_a) {
    ...
    return (_jsx(DropdownMenuPrimitive.Item, Object.assign({
...
function DropdownMenuCheckboxItem(_a) {
    ...
    return (_jsxs(DropdownMenuPrimitive.CheckboxItem, Object.assign({
        ...
        children: [_jsx("span", {
            ...
            children: _jsx(DropdownMenuPrimitive.ItemIndicator, {children: _jsx(CheckIcon, {className: "size-4"})})
        }), children]
    })));
}
...
function DropdownMenuRadioItem(_a) {
    ...
    return (_jsxs(DropdownMenuPrimitive.RadioItem, Object.assign({
        "data-slot": "dropdown-menu-radio-item",
        className: cn("focus:bg-accent focus:text-accent-foreground relative flex cursor-default items-center gap-2 rounded-sm py-1.5 pr-2 pl-8 text-sm outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4", className)
    }, props, {
        children: [_jsx("span", {
            className: "pointer-events-none absolute left-2 flex size-3.5 items-center justify-center",
            children: _jsx(DropdownMenuPrimitive.ItemIndicator, {children: _jsx(CircleIcon, {className: "size-2 fill-current"})})
        }), children]
    })));
}
...
function DropdownMenuLabel(_a) {
    ...
    return (_jsx(DropdownMenuPrimitive.Label, Object.assign({
...
function DropdownMenuSeparator(_a) {
    ...
    return (_jsx(DropdownMenuPrimitive.Separator, Object.assign({
...
function DropdownMenuSubTrigger(_a) {
    ...
    return (_jsxs(DropdownMenuPrimitive.SubTrigger, Object.assign({
...
function DropdownMenuSubContent(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(DropdownMenuPrimitive.SubContent, Object.assign({
