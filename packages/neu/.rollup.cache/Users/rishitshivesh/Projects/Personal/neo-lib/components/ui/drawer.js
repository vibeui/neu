...
function DrawerOverlay(_a) {
    ...
    return (_jsx(DrawerPrimitive.Overlay, Object.assign({
...
function DrawerContent(_a) {
    ...
    return (_jsxs(DrawerPortal, {
        "data-slot": "drawer-portal", children: [_jsx(DrawerOverlay, {}), _jsxs(DrawerPrimitive.Content, Object.assign({
        ...
        }, props, {children: [_jsx("div", {className: "bg-muted mx-auto mt-4 hidden h-2 w-[100px] shrink-0 rounded-full group-data-[vaul-drawer-direction=bottom]/drawer-content:block"}), children]}))]
    }));
}
...
function DrawerTitle(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(DrawerPrimitive.Title, Object.assign({
...
function DrawerDescription(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(DrawerPrimitive.Description, Object.assign({
