...
function TooltipProvider(_a) {
    ...
    return (_jsx(TooltipPrimitive.Provider, Object.assign({
...
function TooltipContent(_a) {
    ...
    return (_jsx(TooltipPrimitive.Portal, {
        children: _jsxs(TooltipPrimitive.Content, Object.assign({
        ...
        }, props, {children: [children, _jsx(TooltipPrimitive.Arrow, {className: "bg-primary fill-primary z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]"})]}))
    }));
}
