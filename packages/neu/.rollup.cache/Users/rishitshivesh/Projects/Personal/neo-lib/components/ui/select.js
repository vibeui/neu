...
const SelectTrigger = React.forwardRef((_a, ref) => {
    ...
    return (_jsxs(SelectPrimitive.Trigger, Object.assign({
        ref: ref,
        className: cn("bg-neumorphic-bg border border-neumorphic-border shadow-neumorphic-raised text-neumorphic-text", "flex h-11 w-full items-center justify-between rounded-xl px-4 py-3 text-sm transition-all duration-200 outline-none", "focus:shadow-neumorphic-focus focus:border-neumorphic-primary/50", "disabled:cursor-not-allowed disabled:opacity-50", "data-[state=open]:shadow-neumorphic-pressed", "[&>span]:line-clamp-1", className)
    }, props, {
...
function SelectContent(_a) {
    ...
    return (_jsx(SelectPrimitive.Portal, {
        children: _jsxs(SelectPrimitive.Content, Object.assign({
            ...
            children: [_jsx(SelectScrollUpButton, {}), _jsx(SelectPrimitive.Viewport, {
...
function SelectLabel(_a) {
    ...
    return (_jsx(SelectPrimitive.Label, Object.assign({
...
const SelectItem = React.forwardRef((_a, ref) => {
    ...
    return (_jsxs(SelectPrimitive.Item, Object.assign({
        ref: ref,
        className: cn("relative flex w-full cursor-default select-none items-center rounded-lg py-2 pl-8 pr-2 text-sm outline-none transition-all duration-200", "focus:bg-neumorphic-bg focus:shadow-neumorphic-inset focus:text-neumorphic-primary", "data-[disabled]:pointer-events-none data-[disabled]:opacity-50", className)
    }, props, {
        children: [_jsx("span", {
            className: "absolute left-2 flex size-3.5 items-center justify-center",
            children: _jsx(SelectPrimitive.ItemIndicator, {children: _jsx(CheckIcon, {className: "size-4"})})
...
function SelectSeparator(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(SelectPrimitive.Separator, Object.assign({
...
function SelectScrollUpButton(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(SelectPrimitive.ScrollUpButton, Object.assign({
        "data-slot": "select-scroll-up-button",
        className: cn("flex cursor-default items-center justify-center py-1", className)
    }, props, {children: _jsx(ChevronUpIcon, {className: "size-4"})})));
}

function SelectScrollDownButton(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(SelectPrimitive.ScrollDownButton, Object.assign({
        "data-slot": "select-scroll-down-button",
        className: cn("flex cursor-default items-center justify-center py-1", className)
    }, props, {children: _jsx(ChevronDownIcon, {className: "size-4"})})));
}
