...
function ToggleGroup(_a) {
    ...
    return (_jsx(ToggleGroupPrimitive.Root, Object.assign({
        "data-slot": "toggle-group",
        "data-variant": variant,
        "data-size": size,
        className: cn("group/toggle-group flex w-fit items-center rounded-md data-[variant=outline]:shadow-xs", className)
    }, props, {children: _jsx(ToggleGroupContext.Provider, {value: {variant, size}, children: children})})));
}
...
function ToggleGroupItem(_a) {
    ...
    return (_jsx(ToggleGroupPrimitive.Item, Object.assign({
