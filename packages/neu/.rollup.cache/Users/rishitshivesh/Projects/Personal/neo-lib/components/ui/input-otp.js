...
function InputOTP(_a) {
    ...
    return (_jsx(OTPInput, Object.assign({
        "data-slot": "input-otp",
...
function InputOTPSlot(_a) {
    ...
    return (_jsxs("div", Object.assign({
        ...
        children: [char, hasFakeCaret && (_jsx("div", {
            className: "pointer-events-none absolute inset-0 flex items-center justify-center",
            children: _jsx("div", {className: "animate-caret-blink bg-foreground h-4 w-px duration-1000"})
        }))]
    })));
}
