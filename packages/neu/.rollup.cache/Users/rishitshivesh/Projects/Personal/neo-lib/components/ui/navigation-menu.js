...
function NavigationMenu(_a) {
    ...
    return (_jsxs(NavigationMenuPrimitive.Root, Object.assign({
        "data-slot": "navigation-menu",
        "data-viewport": viewport,
        className: cn("group/navigation-menu relative flex max-w-max flex-1 items-center justify-center", className)
    }, props, {children: [children, viewport && _jsx(NavigationMenuViewport, {})]})));
}

function NavigationMenuList(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(NavigationMenuPrimitive.List, Object.assign({
...
function NavigationMenuItem(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(NavigationMenuPrimitive.Item, Object.assign({
...
function NavigationMenuContent(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(NavigationMenuPrimitive.Content, Object.assign({
...
function NavigationMenuViewport(_a) {
    ...
    return (_jsx("div", {
        ...
        children: _jsx(NavigationMenuPrimitive.Viewport, Object.assign({
...
function NavigationMenuLink(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(NavigationMenuPrimitive.Link, Object.assign({
...
function NavigationMenuIndicator(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(NavigationMenuPrimitive.Indicator, Object.assign({
    ...
    }, props, {children: _jsx("div", {className: "bg-border relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm shadow-md"})})));
}
