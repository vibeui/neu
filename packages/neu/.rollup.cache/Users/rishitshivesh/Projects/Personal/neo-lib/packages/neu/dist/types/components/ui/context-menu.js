...
function ContextMenuSubContent(_a) {
    ...
    return (_jsx(ContextMenuPrimitive.SubContent, Object.assign({
...
function ContextMenuContent(_a) {
    ...
    return (_jsx(ContextMenuPrimitive.Portal, {
        children: _jsx(ContextMenuPrimitive.Content, Object.assign({
...
function ContextMenuItem(_a) {
    ...
    return (_jsx(ContextMenuPrimitive.Item, Object.assign({
...
function ContextMenuCheckboxItem(_a) {
    ...
    return (_jsxs(ContextMenuPrimitive.CheckboxItem, Object.assign({
        ...
        children: [_jsx("span", {
            ...
            children: _jsx(ContextMenuPrimitive.ItemIndicator, {children: _jsx(CheckIcon, {className: "size-4"})})
        }), children]
    })));
}
...
function ContextMenuRadioItem(_a) {
    ...
    return (_jsxs(ContextMenuPrimitive.RadioItem, Object.assign({
        ...
        children: [_jsx("span", {
            className: "pointer-events-none absolute left-2 flex size-3.5 items-center justify-center",
            children: _jsx(ContextMenuPrimitive.ItemIndicator, {children: _jsx(CircleIcon, {className: "size-2 fill-current"})})
        }), children]
    })));
}
...
function ContextMenuLabel(_a) {
    ...
    return (_jsx(ContextMenuPrimitive.Label, Object.assign({
...
function ContextMenuSeparator(_a) {
    var {className} = _a, props = __rest(_a, ["className"]);
    return (_jsx(ContextMenuPrimitive.Separator, Object.assign({
